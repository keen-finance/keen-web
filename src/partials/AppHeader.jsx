        ...
        <div className="px-5 pt-4 pb-4  space-y-4">
          <div>
            ...
            <div className=' text-sm h-10 w-full flex flex-row  justify-center item-center rounded bg-gray-500 mt-2'  onClick={()=>{
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 my-auto mx-2 text-purple-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <div className='space-y-1'>
            ...
            <div className='flex justify-between'>
              ...
              <div className='flex'>
                <svg t="1658330660817" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1968" width="20" height="20">

          ...
          <div className="w-full">
            ...
            <Controller
              ...
              <div className='bg-slate-700 rounded-2xl  p-3'>
                ...
                <input id="inAmount0" name='inAmount0' type="number" className="form-input w-full text-white text-lg  border-none " placeholder="0.0" {...field} />

                <div className='flex text-sm items-center justify-around space-x-2 w-full'>
                  <div className='font-semibold items-center cursor-pointer justify-center border-4 border-purple-600 hover:border-purple-700  rounded-2xl text-purple-600 hover:text-purple-700 duration-150 ease-in-out px-2'>
                  25%
                  </div>
                  <div className='font-semibold items-center cursor-pointer justify-center border-4 border-purple-600 hover:border-purple-700  rounded-2xl text-purple-600 hover:text-purple-700 duration-150 ease-in-out px-2'>
                  50%

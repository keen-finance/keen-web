      ...
      <form className=" mx-auto">
        ...
        <div className="flex flex-wrap -mx-3 mb-4">
          <div className="w-full px-3 ">
            <label className="flex items-center text-gray-300 font-medium space-x-2" htmlFor="email">
              <div className='bg-gray-900 border border-slate-700 rounded-t-xl flex p-3'>
                <img src={usdtLogo} className='mr-1 h-8 w-8 bg-white rounded-full'/>

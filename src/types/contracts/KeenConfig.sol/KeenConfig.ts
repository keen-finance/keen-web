...
export interface KeenConfigInterface extends utils.Interface {
  functions: {
    "DAY_SECONDS()": FunctionFragment;
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "MONTH_SECONDS()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MONTH_SECONDS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface KeenConfig extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KeenConfigInterface;
  ...
  functions: {
    ...
    MONTH_SECONDS(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    getInviteRates(
      overrides?: CallOverrides
    ): Promise<[BigNumber[]] & { _inviteRates: BigNumber[] }>;
  ...
  populateTransaction: {
    ...
    MONTH_SECONDS(overrides?: CallOverrides): Promise<PopulatedTransaction>;

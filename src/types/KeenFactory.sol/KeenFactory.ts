...
export interface KeenFactoryInterface extends utils.Interface {
  functions: {
    ...
    "createPair(address,address,address,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "allPairs"
      | "allPairsLength"
      | "createPair(address,address,address,address)"
  ...
  encodeFunctionData(
    functionFragment: "createPair(address,address,address,address)",
    values: [
...
export interface KeenFactory extends BaseContract {
  ...
  functions: {
    ...
    "createPair(address,address,address,address)"(
      ...
      replaceTokenA: PromiseOrValue<string>,
      tokenB: PromiseOrValue<string>,
      replaceTokenB: PromiseOrValue<string>,
